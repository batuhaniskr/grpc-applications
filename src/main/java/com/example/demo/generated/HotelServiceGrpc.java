...
public final class HotelServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<HotelRequest,
          HotelResponse> METHOD_GET_HOTEL =
      io.grpc.MethodDescriptor.<HotelRequest, HotelResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.demo.HotelService", "getHotel"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              HotelRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              HotelResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HotelServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getHotel(HotelRequest request,
        io.grpc.stub.StreamObserver<HotelResponse> responseObserver) {
  ...
  public static final class HotelServiceFutureStub extends io.grpc.stub.AbstractStub<HotelServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<HotelResponse> getHotel(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HOTEL:
          serviceImpl.getHotel((HotelRequest) request,
              (io.grpc.stub.StreamObserver<HotelResponse>) responseObserver);
          break;
        default:
  ...
  private static final class HotelServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return HotelServiceOuterClass.getDescriptor();
    }
  }
